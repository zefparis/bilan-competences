    ...
    <div className="min-h-screen bg-[#FAF8F5] text-[#2C2C2C]">
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="space-y-8 text-[#2C2C2C]">
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#8C5A2B]">1. Éditeur du site</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#8C5A2B]">2. Hébergement</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#8C5A2B]">3. Propriété intellectuelle</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#8C5A2B]">4. Responsabilité</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#8C5A2B]">5. Liens hypertextes</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#8C5A2B]">6. Droit applicable</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4 text-[#8C5A2B]">7. Contact</h2>
            <p>
